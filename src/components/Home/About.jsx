            ...
            <Row>
              <Col md={8} className="home-about-description">
                ...
                <br />
                  ...
                  with <b className="yellow">backends like flask, nodejs, django</b> and
                  <i>
                    <b className="yellow">
                      {" "}
              ...
              <Col md={12} className="home-about-social">
                ...
                <ul className="home-about-social-links">
                  <li className="social-icons">
                    <a
                      href="https://github.com/KrishRathor"
                      target="_blank"
                      rel="noreferrer"
                  ...
                  <li className="social-icons">
                    <a
                      href="https://twitter.com/KrishRathor18"
                      target="_blank"
                      rel="noreferrer"
                      className="icon-colour  home-social-icons"
                      aria-label="twitter"
                  ...
                  <li className="social-icons">
                    <a
                      href="https://www.linkedin.com/in/krish-rathor-1b2714188/"
                      target="_blank"
                      rel="noreferrer"
                      className="icon-colour  home-social-icons"
                      aria-label="linkedin"
